pub mod day2 {
    pub fn add_invalid_ids(id_ranges: &str) -> u64 {
        ...
        for range in id_ranges.split(',') {
            total_sum = total_sum + sum_invalid_ids_in_range(range);
        }
        total_sum
    }

    pub fn sum_invalid_ids_in_range(range: &str) -> u64 {
        ...
        let start: u64 = start.parse().expect("Given non-number in range: {start}");

        let end: &str = &range[split+1..];
        let end_num_digits: usize = end.len();
        let end: u64 = end.parse().expect("Given non-number in range: {end}");
        ...
        let mut tracker:u32 = (start / 10_u64.pow(start_num_digits as u32 / 2)) as u32;
        let mut invalid_id: u64 = double_number(tracker);
        while invalid_id <= end {
            if invalid_id >= start {
                sum = sum + invalid_id;
            }
    ...
    pub fn double_number(num: u32) -> u64 {
        // "doubles" the number in a stringlike fashion
        // eg. double_number(123) returns 123123
        let num_digits: u32 = count_digits(num as u64);
        let doubled: u64 = num as u64 * 10_u64.pow(num_digits) + num as u64;
        doubled
    }
...
mod tests {
    ...
    fn day2_test_double_number_1() {
        let result: u64 = double_number(10);
        assert_eq!(result, 1010);
    }

    #[test]
    fn day2_test_double_number_2() {
        let result: u64 = double_number(123);
    ...
    fn day2_test_sum_in_range_simple_even() {
        let result: u64 = sum_invalid_ids_in_range("11-87");
        let expected: u64 = 11 + 22 + 33 + 44 + 55 + 66 + 77;
        assert_eq!(result, expected);
    }

    #[test]
    fn day2_test_sum_in_range_simple_odd() {
        let result: u64 = sum_invalid_ids_in_range("101-999");
        assert_eq!(result, 0);
    }

    #[test]
    fn day2_test_sum_in_range_overlap_even() {
        let result: u64 = sum_invalid_ids_in_range("90-1011");
        let expected: u64 = 99 + 1010;
        assert_eq!(result, expected);
    }

    #[test]
    fn day2_test_sum_in_range_overlap_odd() {
        let result: u64 = sum_invalid_ids_in_range("1-333");
        let expected: u64 = 11 + 22 + 33 + 44 + 55 + 66 + 77 + 88 + 99;
        assert_eq!(result, expected);
    }
    ...
    fn day2_test_add_invalid_ids() {
        ...
        let result: u64 = add_invalid_ids(input);
